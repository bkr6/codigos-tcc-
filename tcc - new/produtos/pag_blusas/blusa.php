...
<head>
    ...
    <title>Lazzy - Blusa</title>
    <link rel="shortcut icon" href="/tcc - new/Assets/img/logo-lazzy-icone.ico" type="image/x-icon">
...
<header class="cabecalho">
    ...
    <div class="banner-camiseta">
        <img src="/tcc - new/Assets/img/LAZZY (4).png" alt="">
    </div>
